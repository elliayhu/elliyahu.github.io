...
define('projects/akamai/akamai',["exports"], function (exports) {
    ...
    var Akamai = exports.Akamai = function Akamai() {
        ...
        this.items = [{ src: "src/images/akamai/01.jpg" }, { src: "src/images/akamai/09.jpg" }, { src: "src/images/akamai/10.jpg" }, { src: "src/images/akamai/13.jpg" }, { src: "src/images/akamai/16.jpg" }, { src: "src/images/akamai/17.jpg" }, { src: "src/images/akamai/17.jpg" }, { src: "src/images/akamai/22.jpg" }, { src: "src/images/akamai/23.jpg" }];
...
define('projects/schindler/schindler',["exports"], function (exports) {
    ...
    var Schindler = exports.Schindler = function Schindler() {
        ...
        this.items = [{ src: "src/images/schindler/02.jpg" }, { src: "src/images/schindler/03.jpg" }, { src: "src/images/schindler/04.jpg" }, { src: "src/images/schindler/04.jpg" }, { src: "src/images/schindler/06.jpg" }, { src: "src/images/schindler/09.jpg" }, { src: "src/images/schindler/11.jpg" }, { src: "src/images/schindler/15.jpg" }, { src: "src/images/schindler/18.jpg" }];
...
define('text!about-us/about-us.html', ['module'], function(module) { module.exports = "<template><require from=\"../head-page-new/head-page-new.html\"></require><head-page-new></head-page-new><div class=\"container-fluid\"><div class=\"container-fluid w-100\"><div class=\"row pt-2\"><div class=\"col-11\"><h1 class=\"customfont-bold top-gold text-center pb-5\" if.bind=\"hebrew\">${titleH1}</h1><h1 class=\"customfont-bold top-gold text-center pb-5\" if.bind=\"!hebrew\">${titleH1E}</h1></div><div class=\"col-1\"><button type=\"button\" class=\"rounded-circle btn btn-dark top-gold\" click.delegate=\"languageChange()\">${buttonText}</button></div></div></div><div class=\"row mx-5\"><div class=\"col-5\" if.bind=\"hebrew\"><h5 class=\"customfont-bold top-gold text-right\">${title1H5}</h5><p class=\"top-gold text-right\">${paragraph1}</p><h5 class=\"customfont-bold top-gold text-right\">${title2H5}</h5><p class=\"top-gold text-right\">${Paragraph2}</p><p class=\"top-gold text-right\">${paragraph3}</p><h5 class=\"customfont-bold top-gold text-right\">${title3H5}</h5><p class=\"top-gold text-right\">${paragraph4}</p><p class=\"top-gold text-right\">${paragraph5}</p><p class=\"top-gold text-right\">${paragraph6}</p><p class=\"top-gold text-right\">${paragraph7}</p><p class=\"top-gold text-right\">${paragraph8}</p></div><div class=\"col-7\"><div class=\"row justify-content-center px-5 h-100\"><div repeat.for=\"item of logos\" class=\"col-md-4 d-flex align-items-center\"><img src.bind=\"item.src\" alt=\"Lights\" class=\"w-100\"></div></div></div><div class=\"col-5 top-direction\" if.bind=\"!hebrew\"><h5 class=\"customfont-bold top-gold\">${title1H5E}</h5><p class=\"top-gold\">${paragraph1E}</p><h5 class=\"customfont-bold top-gold\">${title2H5E}</h5><p class=\"top-gold\">${Paragraph2E}</p><p class=\"top-gold\">${Paragraph2E2}</p><p class=\"top-gold\">${paragraph3E}</p><h5 class=\"customfont-bold top-gold\">${title3H5E}</h5><p class=\"top-gold\">${paragraph4E}</p><p class=\"top-gold\">${paragraph5E}</p><p class=\"top-gold\">${paragraph6E}</p><p class=\"top-gold\">${paragraph7E}</p><p class=\"top-gold\">${paragraph8E}</p><p class=\"top-gold\">${paragraph9E}</p><p class=\"top-gold\">${paragraph10E1}</p><p class=\"top-gold\">${paragraph10E2}</p><p class=\"top-gold\">${paragraph10E3}</p><p class=\"top-gold\">${paragraph10E4}</p><p class=\"top-gold\">${paragraph11E}</p><p class=\"top-gold\">${paragraph12E}</p><p class=\"top-gold\">${paragraph13E}</p><p class=\"top-gold\">${paragraph14E}</p><p class=\"top-gold\">${paragraph15E}</p><p class=\"top-gold\">${paragraph16E}</p><p class=\"top-gold\">${paragraph17E}</p><p class=\"top-gold\">${paragraph18E}</p><p class=\"top-gold\">${paragraph19E}</p><p class=\"top-gold\">${paragraph20E}</p><p class=\"top-gold\">${paragraph21E}</p><p class=\"top-gold\">${paragraph22E}</p></div></div></div></template>"; });
...
define('text!projects/project-view/project-view.html', ['module'], function(module) { module.exports = "<template><require from=\"../../head-page-new/head-page-new.html\"></require><div class=\"d-flex flex-column h-100\"><head-page-new></head-page-new><h2 class=\"customfont-bold text-center top-gold mb-3\">${topTitle}</h2><div id=\"carouselExampleControls\" class=\"d-flex carousel slide container h-100 w-75 pb-2\" data-ride=\"carousel\"><div class=\"carousel-inner h-100\"><div class=\"carousel-item h-100 active\"><img class=\"d-block h-100 w-100\" src.bind=\"firstPicture\" alt=\"First slide\"></div><div repeat.for=\"item of pictures\" class=\"carousel-item h-100\"><img class=\"d-block h-100 w-100\" src.bind=\"item.src\" alt=\"Second slide\"></div><div class=\"text-box-info w-50\" id=\"style-scrollbar\"><h3 class=\"customfont-bold text-center top-direction-r m-3\">${title}</h3><article><p repeat.for=\"item of paragraphes\" class=\"text-right top-direction-r m-2\">${item.paragraph}</p></article></div></div><a class=\"carousel-control-prev\" href=\"#carouselExampleControls\" role=\"button\" data-slide=\"prev\"><span class=\"carousel-control-prev-icon\" aria-hidden=\"true\"></span> <span class=\"sr-only\">Previous</span> </a><a class=\"carousel-control-next\" href=\"#carouselExampleControls\" role=\"button\" data-slide=\"next\"><span class=\"carousel-control-next-icon\" aria-hidden=\"true\"></span> <span class=\"sr-only\">Next</span></a></div></div></template>"; });
